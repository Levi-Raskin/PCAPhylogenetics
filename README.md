...
resultsGit
  - includes all the files needed to reproduce the results we got in our paper. Does not include raw simulated data or the raw tree file as that would be too large to store in github.
